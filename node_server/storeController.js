...
const storeController = {
    getMyStoreMainImage: async (req, res) => {
        // 이미지 가져오기
    ...
    getAllCompanyRegistrationNumber: async (req, res) => {
        // 모든 사업자 등록 번호 가져오기 로직...
        connection.query(
